                                                ...
                                                <div class="job-block">
                                                    <div class="inner-box">
                                                        <div class="content">
                                                            ...
                                                            <h4>
                                                                <a :href="'/en/job/'+short.job.id" v-if="short.type == 'job'">{{ short.job.title }}</a>
                                                                <a :href="'/en/u/'+short.resume.username" v-if="short.type == 'resume'">{{ short.resume.name }}</a>
                                                                <a :href="'/en/u/'+short.company.username" v-if="short.type == 'company'">{{ short.company.name }}</a>
                                                                <a :href="'/en/u/'+short.business.username" v-if="short.type == 'business'">{{ short.business.b_name }}</a>
                                                            </h4>
                                                            <ul class="job-info" v-if="short.type == 'job'">
                                                                <li v-if="short.job.user">
                                                                    <a :href="'/en/u/' + short.job.user.username">
                                            ...
                                            <td>
                                                <div class="option-box">
                                                    <ul class="option-list" v-if="short.type == 'job'">
                                                        <li>
                                                            <a :href="'/en/job/' + short.job.id" data-text="View Job">
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'resume'">
                                                        <li>
                                                            <a :href="'/en/u/' + short.resume.username" data-text="View Job">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'company'">
                                                        <li>
                                                            <a :href="'/en/u/' + short.company.username" data-text="View Job">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'business'">
                                                        <li>
                                                            <a :href="'/en/u/' + short.business.username" data-text="View Job">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
