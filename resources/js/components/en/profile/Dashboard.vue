                                    ...
                                    <div class="upper-title-box">
                                        ...
                                        <ul class="complete-profile-list">
                                            <li v-if="user.complete.profile > 5">
                                                <a href="/en/profile">Complete your information</a>
                                            </li>
                                            <li v-if="user.complete.portfolio">
                                                <a href="/en/profile/portfolio">Create Attractive Gallery</a>
                                            </li>
                                            <li v-if="user.complete.edu">
                                                <a href="/en/profile/resume">Add Education Levels</a>
                                            </li>
                                            <li v-if="user.complete.exp">
                                                <a href="/en/profile/resume">Add Experience Careers</a>
                                            </li>
                                            <li v-if="user.complete.cv">
                                                <a href="/en/profile/resume">Upload your CV</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="tabs-box">
                                <div class="widget-title">
                                    ...
                                    <div class="chosen-outer">
                                        <a href="/en/jobs" v-if="suggestedJobs.length > 0">Show All</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center py-3" v-else>
                                            <h6 class="mb-4">
                                                ...
                                                <a href="/en/profile">Complete your profile</a>.
                                            </h6>
                                            <a href="/en/profile">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="applicants-widget ls-widget">
                            <div class="widget-title">
                                ...
                                <div class="chosen-outer">
                                    <a href="/en/profile/applied-jobs">Show All</a>
                                </div>
                            </div>
                                    ...
                                    <div class="job-block col-lg-6 col-md-12 col-sm-12"
                                        ...
                                        <div class="inner-box">
                                            <div class="content">
                                                ...
                                                <h4>
                                                    <a :href="'/en/job/'+ applicant.job.id">{{ applicant.job.title }}</a>
                                                </h4>
                                                <ul class="job-info">
                                                    <li>
                            ...
                            <div class="widget-content">
                                <ul class="notification-list" v-if="notifications.length">
                                    <li v-for="(notification, index) in notifications" :key="index">
                                        <span class="icon flaticon-briefcase"></span>
                                        <a :href="'/en/u/'+notification.data.candidate.username"><strong>{{
                                                notification.data.candidate.name
                                            }}</strong></a>
                                        applied for a job
                                        <a :href="'/en/job/'+notification.data.job.id">
