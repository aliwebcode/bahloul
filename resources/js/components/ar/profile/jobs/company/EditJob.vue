                            ...
                            <div class="widget-content">
                                ...
                                <form class="default-form">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12">
                                            <!-- Input -->
                                            <span class="title">تاريخ إنتهاء الصلاحية</span>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 my-auto">
                                            ...
                                            <label class="switch">
                                                ...
                                                <span class="title">عرض عدد المتقدمين</span>
                                            </label>
                                        </div>
...
export default {
    mounted() {
        ...
        // Get User
        axios.get('/request/profile/get-edit-job/' + job_id)
            .then((res) => {
                if(res.data == 0) {
    ...
    methods: {
        ...
        saveJob: function () {
            ...
            axios.post("/request/profile/update-job", {
                job: this.job
            })
                .then((res) => {
        ...
        setSkills: function () {
            this.job.skills = this.job.skill.join()
        },
    }
}
</script>
