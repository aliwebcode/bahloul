                                ...
                                <div class="table-outer">
                                    <table class="default-table manage-job-table">
                                        ...
                                        <tr v-if="shortlists.length == 0">
                                            <td colspan="4"><p class="text-center">لم يتم إضافة إختصارات بعد.</p></td>
                                        </tr>
                                        <tr v-for="(short, index) in shortlists" :key="short.id">
                                                ...
                                                <div class="job-block">
                                                    <div class="inner-box">
                                                        <div class="content">
                                                            ...
                                                            <h4>
                                                                <a :href="'/ar/job/'+short.job.id" v-if="short.type == 'job'">{{ short.job.title }}</a>
                                                                <a :href="'/ar/u/'+short.resume.username" v-if="short.type == 'resume'">{{ short.resume.name }}</a>
                                                                <a :href="'/ar/u/'+short.company.username" v-if="short.type == 'company'">{{ short.company.name }}</a>
                                                                <a :href="'/ar/u/'+short.business.username" v-if="short.type == 'business'">{{ short.business.b_name }}</a>
                                                            </h4>
                                                            <ul class="job-info" v-if="short.type == 'job'">
                                                                <li v-if="short.job.user">
                                                                    <a :href="'/ar/u/' + short.job.user.username">
                                                            ...
                                                            <ul class="job-info" v-if="short.type == 'business'">
                                                                <li v-if="short.business.category">
                                                                    <span class="icon flaticon-briefcase"></span>
                                                                    {{ short.business.category.name_ar }}
                                                                </li>
                                            ...
                                            <td>
                                                <button type="button"
                                                        class="sh-type"
                                                        style="text-transform:capitalize;" v-if="short.type == 'job'">وظيفة
                                                </button>
                                                <button type="button"
                                                        class="sh-type"
                                                        style="text-transform:capitalize;" v-if="short.type == 'resume'">متقدم
                                                </button>
                                                <button type="button"
                                                        class="sh-type"
                                                        style="text-transform:capitalize;" v-if="short.type == 'company'">شركة
                                                </button>
                                                <button type="button"
                                                        class="sh-type"
                                                        style="text-transform:capitalize;" v-if="short.type == 'business'">عمل محلي
                                                </button>
                                            </td>
                                            <td>{{ short.time }}</td>
                                            <td>
                                                <div class="option-box">
                                                    <ul class="option-list" v-if="short.type == 'job'">
                                                        <li>
                                                            <a :href="'/ar/job/' + short.job.id" data-text="معاينة">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <button data-text="حذف" @click="deleteModal=true,i=index">
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'resume'">
                                                        <li>
                                                            <a :href="'/ar/u/' + short.resume.username" data-text="معاينة">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'company'">
                                                        <li>
                                                            <a :href="'/ar/u/' + short.company.username" data-text="معاينة">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <ul class="option-list" v-if="short.type == 'business'">
                                                        <li>
                                                            <a :href="'/ar/u/' + short.business.username" data-text="معاينة">
                                                                <span class="la la-eye"></span>
                                                            </a>
                                                        </li>
                                                        <li>
