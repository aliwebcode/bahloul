                    ...
                    <div class="candidate-block-five">
                        <div class="inner-box">
                            <div class="content">
                                ...
                                <h4 class="name">
                                    <a :href="'/ar/u/'+user.username">{{ user.name }}</a>
                                </h4>
                    ...
                    <div class="row">
                        <div class="content-column col-lg-8 col-md-12 col-sm-12">
                            <div class="job-detail" v-if="selectedPortfolio == null">
                                <h4>نبذة عن {{ user.name }}</h4>
                                <p v-if="user.description">{{ user.description }}</p>
                                <p v-else>لم يتم إضافة نبذة.</p>
                                <!-- Resume / Education -->
                                    ...
                                    <div class="widget-content">
                                        <ul class="job-overview">
                                            <li v-if="user.experience">
                                                ...
                                                <h5>الخبرة:</h5>
                                                <span>{{ user.experience }} سنوات</span>
                                            </li>
...
<!--                                            </li>-->
                                            ...
                                            <li v-if="user.gender">
                                                ...
                                                <span v-else-if="user.gender == 'female'">أنثى</span>
                                            </li>
                                ...
                                <div class="sidebar-widget social-media-widget"
                                    ...
                                    <h4 class="widget-title">حسابات التواصل الاجتماعي</h4>
                                    <div class="widget-content">
                                ...
                                <div class="sidebar-widget" v-if="user.skill">
                                    <!-- Job Skills -->
                                    <h4 class="widget-title">المهارات</h4>
                                    <div class="widget-content">
                                        <ul class="job-skills">
                    ...
                    <div class="job-block-seven">
                        <div class="inner-box">
                            <div class="content">
                                ...
                                <h4><a :href="'/ar/u/'+user.username">{{ user.name }}</a></h4>
                                <ul class="job-info">
                                    <li v-if="user.country">
                                        <span class="icon flaticon-map-locator"></span>
                                        {{ user.city.name }}, {{ user.country.name }}
                    ...
                    <div class="row">
                        <div class="content-column col-lg-8 col-md-12 col-sm-12">
                            <div class="job-detail" v-if="selectedPortfolio == null">
                                ...
                                <h6 class="mb-3" v-else>لم يتم إضافة نبذة.</h6>
                                <!-- Portfolio -->
                                <div class="portfolio-outer">
                                    <div class="row" v-if="user.user_portfolio.length > 0">
                                        <div class="col-12">
                            ...
                            <div class="related-jobs" v-if="user.jobs.length">
                                <div class="title-box">
                                    <h3 style="font-size: 20px;">{{ user.jobs.length }} وظيفة في {{ user.name }}</h3>
                                </div>
                                    ...
                                    <div class="inner-box">
                                        <div class="content">
                                            ...
                                            <ul class="job-other-info">
                                                ...
                                                <li class="time bg-danger text-white" v-if="job.expire == 0">مغلق</li>
                                            </ul>
                                ...
                                <div class="sidebar-widget company-widget">
                                    <div class="widget-content">
                                        ...
                                        <ul class="company-info mt-0">
                                            <li v-if="user.company_size">حجم الشركة: <span>{{ user.company_size }}</span></li>
                                            <li v-if="user.founded_in">تأسست عام: <span>{{ user.founded_in }}</span></li>
                                            <li v-if="user.phone">الهاتف: <span>{{ user.phone }}</span></li>
                                            <li v-if="user.company_email">البريد الإلكتروني: <span>{{ user.company_email }}</span></li>
                                            <li v-if="user.country">البلد: <span>{{ user.country.name }}</span></li>
                                            <li v-if="user.city">المدينة: <span>{{ user.city.name }}</span></li>
                                            <li v-if="user.address">العنوان: <span>{{ user.address }}</span></li>
                                            <li v-if="user.zip">الرمز البريدي: <span>{{ user.zip }}</span></li>
                                        ...
                                        <div class="btn-box" v-if="user.website">
                                            <a :href="user.website" class="theme-btn btn-style-three">
                                                زيارة الموقع الإلكتروني <i class="fa fa-external-link-alt"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="auto-container">
                    ...
                    <div class="candidate-block-six">
                        <div class="inner-box">
                            ...
                            <h4 class="name">
                                <a :href="'/ar/u/'+user.username">{{ user.b_name }}</a>
                            </h4>
                ...
                <div class="auto-container">
                    <div class="row">
                        <div class="content-column col-lg-8 col-md-12 col-sm-12 order-2">
                            <div class="job-detail" v-if="selectedPortfolio == null">
                                <h4>نبذة عن {{ user.b_name ? user.b_name : '' }}</h4>
                                <p v-if="user.description">{{ user.description }}</p>
                                <p v-else>لم يتم إضافة نبذة</p>
                                <!-- Portfolio -->
                                <div class="portfolio-outer">
    ...
    mounted() {
        ...
        axios.get("/request/front/get-user-profile/" + username)
            .then((res) => {
                if(res.data == 0) {
                    this.notFound = true
                    document.title = "بهلول - المستخدم غير موجود"
                } else {
                    this.user = res.data
                    document.title = "بهلول - " + this.user.name
                }
            })
            .catch((err) => {
                console.log(err)
