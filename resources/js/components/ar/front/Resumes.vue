                        ...
                        <div class="ls-outer">
                            ...
                            <ul class="tags-style-one">
                                ...
                                <li v-if="settings.date">
                                    <button type="button">
                                        التاريخ: {{
                                            settings.date > 1 ? 'آخر ' + settings.date + ' أيام' : 'آخر 24 ساعة'
                                        }}
                                        <span class="icon flaticon-close-1 ml-2"
                            ...
                            <div class="row" v-if="resumes.data.length">
                                ...
                                <div class="candidate-block-four col-lg-6 col-md-6 col-sm-12"
                                    ...
                                    <div class="inner-box">
                                        ...
                                        <h3 class="name">
                                            <a :href="'/ar/u/' + resume.username">{{ resume.name }}</a>
                                        </h3>
                                        ...
                                        <a :href="'/ar/u/' + resume.username" class="theme-btn btn-style-three">
                                            عرض الملف الشخصي
                                        </a>
                                    </div>
                                </div>
...
export default {
    mounted() {
        ...
        document.title = "بهلول - المستقلين"
